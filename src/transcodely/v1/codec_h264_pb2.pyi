...
class H264Options(_message.Message):
    __slots__ = ("preset", "tune", "profile", "level", "crf", "bitrate", "maxrate", "bufsize", "keyint", "min_keyint", "bframes", "ref", "rc_lookahead", "aq_mode", "aq_strength", "psy_rd", "deblock")
